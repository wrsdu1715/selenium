...
def get_store_name():
    ...
    tmp = driver.find_elements(
        By.CSS_SELECTOR,
        "#rstdtl-head > div.rstdtl-header.unofficial > section > div.rdheader-title-data > div.rdheader-rstname-wrap > div.rdheader-rstname > h2 > span",
    )
    if not tmp:
        tmp = driver.find_elements(
            By.CSS_SELECTOR,
            "#rstdtl-head > div.rstdtl-header > section > div.rdheader-title-data > div.rdheader-rstname-wrap > div.rdheader-rstname > h2 > a",
        )
    if not tmp:
        tmp = driver.find_elements(
            By.CSS_SELECTOR,
            "#rstdtl-head > div.rstdtl-header > section > div.rdheader-title-data > div.rdheader-rstname-wrap > div.rdheader-rstname > h2 > span",
        )
...
def get_store_address():
    store_address = driver.find_element(
        By.CSS_SELECTOR,
        "#column-main > div.map-rstinfo > table > tbody > tr:nth-child(1) > td",
    ).text
